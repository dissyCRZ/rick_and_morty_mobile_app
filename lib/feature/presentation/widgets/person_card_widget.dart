          ...
          children: [
            ...
            Expanded(
              ...
              children: [
                ...
                const SizedBox(height: 12),
                const Text('Last know location: ', style: TextStyle(color: AppColors.greyColor),),
                const SizedBox(height: 4),
                Text('${person.location.name}', style: const TextStyle(color: Colors.white), maxLines: 1, overflow: TextOverflow.ellipsis,),
                const SizedBox(height: 12),
                const Text('Origin:', style: TextStyle(color: AppColors.greyColor),),
                const SizedBox(height: 4),
                Text('${person.origin.name}', style: const TextStyle(color: Colors.white), maxLines: 1, overflow: TextOverflow.ellipsis,),
